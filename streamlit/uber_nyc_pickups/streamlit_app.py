...
filtered = data[(data[DATE_TIME].dt.hour >= hour_selected) &
...
st.write("**Breakdown of rides per minute between %i:00 and %i:00**" %
         (hour_selected, (hour_selected + 1) % 24))
...
st.altair_chart(
    ...
    .encode(x=alt.X("minute:Q", scale=alt.Scale(nice=False)), y=alt.Y("pickups:Q"), tooltip=['minute', 'pickups'])
